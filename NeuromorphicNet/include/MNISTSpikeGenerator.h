...
class MNISTSpikeGenerator : public SpikeGenerator {
public:
    MNISTSpikeGenerator(double duration = 0.1, double dt = 0.001, double f_max = 100.0)
        : SpikeGenerator(duration, dt, f_max), mnist_reader_() {}
